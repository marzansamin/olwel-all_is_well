...
const Navbar = () => {
  return (
    <div className='bg-[#CEDEBD] h-[10%] w-full p-4 border transition-all duration-500 border-solid border-[#CEDEBD] relative flex flex-row justify-between items-center overflow-y-auto shadow-2xl' style={{ backdropFilter: 'blur(10px)', opacity: '0.9', zIndex: '1' }}>
